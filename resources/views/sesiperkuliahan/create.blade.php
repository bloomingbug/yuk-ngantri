...
@section('judul')
    {{ __('Tambah Sesi Mata Kuliah ' . $matkul->nama) }}
@endsection

@section('judulkonten')
    {{ __('Tambah Sesi Mata Kuliah') }}
@endsection
...
@section('konten')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <form action="/sesi-perkuliahan" method="post">
                        @csrf
                        @error('nama')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="nama"
                                    name="nama" value="{{ old('nama') }}" placeholder="Contoh: Sesi Siang/Sesi 1"
                                    required autofocus>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('mata_kuliah_id') is-invalid @enderror"
                            id="mata_kuliah_id" name="mata_kuliah_id" value="{{ $matkul->id }}" required hidden>
                        {{-- End of Matkul --}}
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="custom-select" id="ruangan_id" name="ruangan_id" required>
                                    <option selected hidden disabled>--Pilih Ruangan--</option>
